...
try:
    ...
    print(BrainFlowError)

if board_shim != None:
    # Enable EEG mode and read 5 seconds of EEG data
    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.EEG_MODE)
    ...
    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.IMP_MODE)
    ...
    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.EEG_MODE)
    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.TEST_SIGNAL)
    print("Device configured in EEG mode")
    ...
    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.BEEP)
    print("BEEP sent")

    board_shim.config_board(mindrove_brainflow.MindroveConfigMode.BOOP)
    print("BOOP sent")
